...
var Icon = function Icon(_ref) {
  var icon = _ref.icon,
      ...
      props = _objectWithoutProperties(_ref, ["icon", "block", "visible", "className"]);
  ...
  }, props), _typeof(icons[icon]) === 'object' ? React.createElement(React.Fragment, null, React.createElement(Path, {
    className: "primary",
