...
describe('MultiSelect Component', function () {
  ...
  describe('disabled', function () {
    test('has "disabled" class', function () {
      var _render3 = render(React.createElement(MultiSelect, {
        options: options,
        disabled: true
      })),
  ...
  describe('list', function () {
    test('is hidden by default', function () {
      var _render4 = render(React.createElement(MultiSelect, {
        options: options
      })),
    ...
    describe('is visible', function () {
      ...
      test('on label click', function () {
        var _render5 = render(React.createElement(MultiSelect, {
          options: options
        })),
      ...
      test('on input click', function () {
        var _render6 = render(React.createElement(MultiSelect, {
          options: options
        })),
      ...
      test('on icon click', function () {
        var _render7 = render(React.createElement(MultiSelect, {
          options: options
        })),
    ...
    describe('className', function () {
      ...
      describe('is "listWithIcon" with one icon', function () {
        ...
        test('as error', function () {
          var _render8 = render(React.createElement(MultiSelect, {
            options: options,
            error: "foo"
          })),
        ...
        test('as loader', function () {
          var _render9 = render(React.createElement(MultiSelect, {
            options: options,
            loading: true
          })),
        ...
        test('as loader and error', function () {
          var _render10 = render(React.createElement(MultiSelect, {
            options: options,
            loading: true,
            error: "foo"
          })),
        ...
        test('as reset', function () {
          var _render11 = render(React.createElement(MultiSelect, {
            options: options
          })),
      ...
      describe('is "listWithDoubleIcon" with two icons', function () {
        ...
        test('as loading and reset', function () {
          var _render12 = render(React.createElement(MultiSelect, {
            options: options,
            loading: true
          })),
        ...
        test('as error and reset', function () {
          var _render13 = render(React.createElement(MultiSelect, {
            options: options,
            error: "foo"
          })),
    ...
    test('renders "selectedOptions" properly', function () {
      var _render14 = render(React.createElement(MultiSelect, {
        options: options,
        name: "bar",
    ...
    describe('events', function () {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _render15 = render(React.createElement(MultiSelect, {
                    options: options,
                    name: "bar",
      ...
      describe('fires onResetSelection', function () {
        test('without preselected options', function (done) {
          ...
          var _render16 = render(React.createElement(MultiSelect, {
            options: options,
            name: "bar",
        ...
        describe('with preselected options', function () {
          test('default', function (done) {
            ...
            var _render17 = render(React.createElement(MultiSelect, {
              options: options,
              name: "bar",
              selectedOptions: selectedOptions,
              onResetSelection: handleReset
          ...
          test('add to ChipList then reset', function (done) {
            ...
            var _render18 = render(React.createElement(MultiSelect, {
              options: options,
              name: "bar",
              selectedOptions: selectedOptions,
              onResetSelection: handleReset
          ...
          test('remove from ChipList then reset', function (done) {
            ...
            var _render19 = render(React.createElement(MultiSelect, {
              options: options,
              name: "bar",
              selectedOptions: selectedOptions,
              onResetSelection: handleReset
      ...
      test('closes on list item click', function (done) {
        ...
        var _render20 = render(React.createElement(MultiSelect, {
          options: options,
          name: "bar",
          onSelect: handleSelect
        })),
      ...
      describe('adds item to ChipList', function () {
        test('without preselectedOptions', function (done) {
          ...
          var _render21 = render(React.createElement(MultiSelect, {
            options: options,
            name: "bar",
            onSelect: handleSelect
          })),
        ...
        test('with preselectedOptions', function (done) {
          ...
          var _render22 = render(React.createElement(MultiSelect, {
            options: options,
            name: "bar",
            selectedOptions: selectedOptions,
            onSelect: handleSelect
      ...
      test('removes item from ChipList', function () {
        var _render23 = render(React.createElement(MultiSelect, {
          options: options,
          name: "bar",
          selectedOptions: selectedOptions
        })),
