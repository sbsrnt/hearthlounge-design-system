...
var MultiSelect = function MultiSelect(_ref) {
  ...
  var defaultAvailableItems = selectedOptions ? _differenceBy(options, selectedOptions, 'value') : options;
  ...
  return React.createElement(Downshift, {
    ...
    var resetIcon = !!(inputValue && !_isEmpty(inputValue)) || selectedItem.length > 0;
    return React.createElement("div", {
      ...
      className: resetIcon ? 'multiSelect__chipsAndInputWrapperOpen' : 'multiSelect__chipsAndInputWrapperClose'
