  ...
  describe('list', function () {
    ...
    describe('className', function () {
      ...
      describe('is "listWithDoubleIcon" with two icons', function () {
        ...
        test('as error and reset', function () {
          var _render13 = render(React.createElement(Select, {
            items: items,
            error: "foo"
          })),
    ...
    describe('events', function () {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _render14 = render(React.createElement(Select, {
                    items: items,
                    name: "bar",
      ...
      test('fires onInputReset', function (done) {
        ...
        var _render15 = render(React.createElement(Select, {
          items: items,
          name: "bar",
      ...
      test('closes on list item click', function (done) {
        ...
        var _render16 = render(React.createElement(Select, {
          items: items,
          name: "bar",
          onSelect: handleSelect
        })),
