    ...
    React.createElement(
      ...
      React.createElement(
        ...
        entries.map(function(_ref) {
          ...
          if (
            ![]
              .concat(_toConsumableArray(nestedTokenColors), [
                'medium',
                'border',
                'secondary',
                'lightest',
            ...
            return React.createElement(
              ...
              React.createElement('p', null, _startCase(key)),
              React.createElement(
                'ul',
                null,
      ...
      entries.map(function(_ref3) {
        ...
        if (isExtendedObj) {
          return React.createElement(
            ...
            React.createElement('h3', null, _startCase(key)),
            React.createElement(
              'div',
              {
                className: cx(styles.wrapper, styles.innerWrapper),
              },
              Object.entries(values).map(function(_ref4) {
                ...
                return React.createElement(
                  ...
                  React.createElement('p', null, _startCase(extendedObjKey)),
                  React.createElement(
                    'ul',
                    null,
                    Object.entries(extendedObjValues).map(function(_ref5) {
                      var k = _ref5[0],
                        v = _ref5[1];
                      return React.createElement(
                        'li',
